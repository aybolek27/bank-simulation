...
public class TransactionServiceImpl implements TransactionService {
    ...
    public Transaction makeTransfer(BigDecimal amount, Date creationDate, Account sender, Account receiver, String message) {
        if(!underConstruction) {
            ...
            executeBalanceAndUpdateIfRequired(sender, receiver, amount);
    ...
    private void executeBalanceAndUpdateIfRequired(Account sender, Account receiver, BigDecimal amount) {
    ...
    private void validateAccounts(Account sender, Account receiver) {
        ...
        if (sender.getId().equals(receiver.getId())){
            throw new BadRequestException("Sender Account needs to be different");
        }
        findAccountsById(sender.getId());
        findAccountsById(receiver.getId());

    }

    private Account findAccountsById(UUID accountId) {
